...
<body>
	...
	<div class="container" style="height:100%;">
		<h1 class="center">Welcome to the Employee Portal</h1>
		<fieldset style="border-width: 2px; border-color: black; margin-top:3%; margin-bottom:3%;">
			<legend>User Info:</legend>
			<label>Employee ID:</label> ${user.user_id}<br />
			<label>Name:</label>${user.firstName} ${user.lastName}<br />
			<label>Username:</label>${user.username} <label>Email:</label> ${user.email}
		</fieldset>

		<div class="list-group">
			<a href="?action=makeRequest" class="list-group-item list-group-item-action">Submit a Reimbursement Request</a>
			<a href="?action=userPendReimbs" class="list-group-item list-group-item-action">View Pending Requests</a>
			<a href="?action=userResReimbs" class="list-group-item list-group-item-action">View Reimbursement History</a>
